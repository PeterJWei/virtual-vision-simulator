        ...
        # ------------------ build evaluate_net ------------------
            ...
            with tf.variable_scope('eval_net'):
                ...
                c_names, n_l1, n_l2, w_initializer, b_initializer = \
                    ['eval_net_params', tf.GraphKeys.GLOBAL_VARIABLES], 100 * self.hidden_layer, 100 * self.hidden_layer, \
                    tf.random_normal_initializer(0., 0.3), tf.constant_initializer(0.1)  # config of layers. The number
                    # before multiplication with self.hidden_layeris the number of nodes per hidden layer
                ...
                #    output = tf.add(tf.matmul(l2, w3), b3, name="output")
                ...
                with tf.variable_scope('l3'):
                    ...
                    output = tf.add(tf.matmul(l1, w3), b3, name="output")
