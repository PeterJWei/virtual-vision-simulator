...
def run_maze():
    ...
    x_file = './elen6885/data/x.csv'
    y_file = './elen6885/data/y_a_0_b_1.csv'
    z_file = './elen6885/data/z.csv'
    a_file = './elen6885/data/a.csv'

    #with open('x_6_1.csv') as x, open('y_6_1.csv') as y, open('z_6_1.csv') as z:
    with open(x_file) as x, open(y_file) as y, open(z_file) as z, open(a_file) as a:
        i = 0
        while True:
    ...
    saver.save(RL.sess, "./elen6885/model/model_a_0_b_1/model_a_0_b_1")
